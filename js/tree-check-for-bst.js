...
Your task is to complete the function isBST() which takes the root of the tree as a parameter and returns 
...
class Solution {
    ...
    isBSTUtil(root, min, max) {
        ...
        return (this.isBSTUtil(root.left, min, root.data - 1)
